import { new_output } from './snippets/wasm-4b0f351a8e6eeb46/output_handler.js';
import * as __wbg_star0 from './snippets/wasm-4b0f351a8e6eeb46/output_handler.js';
...
*/
export function interpret(input, args) {
    var ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    wasm.interpret(ptr0, len0, addHeapObject(args));
}
...
async function init(input) {
    ...
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_newoutput_cf1621265ff525c9 = function(arg0, arg1) {
        try {
            new_output(getStringFromWasm0(arg0, arg1));
        } finally {
    ...
    imports['./snippets/wasm-4b0f351a8e6eeb46/output_handler.js'] = __wbg_star0;
